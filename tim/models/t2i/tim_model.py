...
def TiM_XL_2(**kwargs):
    return TiM(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)

def TiM_XL_4(**kwargs):
    return TiM(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)

def TiM_XL_8(**kwargs):
    return TiM(depth=28, hidden_size=1152, patch_size=8, num_heads=16, **kwargs)

def TiM_L_2(**kwargs):
    return TiM(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)

def TiM_L_4(**kwargs):
    return TiM(depth=24, hidden_size=1024, patch_size=4, num_heads=16, **kwargs)

def TiM_L_8(**kwargs):
    return TiM(depth=24, hidden_size=1024, patch_size=8, num_heads=16, **kwargs)

def TiM_B_2(**kwargs):
    return TiM(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)

def TiM_B_4(**kwargs):
    return TiM(depth=12, hidden_size=768, patch_size=4, num_heads=12, **kwargs)

def TiM_B_8(**kwargs):
    return TiM(depth=12, hidden_size=768, patch_size=8, num_heads=12, **kwargs)

def TiM_S_2(**kwargs):
    return TiM(depth=12, hidden_size=384, patch_size=2, num_heads=6, **kwargs)

def TiM_S_4(**kwargs):
    return TiM(depth=12, hidden_size=384, patch_size=4, num_heads=6, **kwargs)

def TiM_S_8(**kwargs):
    return TiM(depth=12, hidden_size=384, patch_size=8, num_heads=6, **kwargs)


TiM_models = {
    'TiM-XL/2': TiM_XL_2,  'TiM-XL/4': TiM_XL_4,  'TiM-XL/8': TiM_XL_8,
    'TiM-L/2':  TiM_L_2,   'TiM-L/4':  TiM_L_4,   'TiM-L/8':  TiM_L_8,
    'TiM-B/2':  TiM_B_2,   'TiM-B/4':  TiM_B_4,   'TiM-B/8':  TiM_B_8,
    'TiM-S/2':  TiM_S_2,   'TiM-S/4':  TiM_S_4,   'TiM-S/8':  TiM_S_8,
}