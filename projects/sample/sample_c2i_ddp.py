...
def main(args):
    ...
    if 'dc-ae' in model_config.vae_dir:
        ...
        # vae_dir = 'workdir/c2i/debug/debug_e2e/checkpoints/save-checkpoint-100000/model_2.safetensors'
        # vae_sd = load_file(vae_dir)
        # va_vae.load_state_dict(vae_sd, strict=True)
