target_dir="datasets/imagenet1k/sd-vae-ft-ema-256x256"
mkdir -p $target_dir
base_url="https://huggingface.co/datasets/GoodEnough/NiT-Preprocessed-ImageNet1K/resolve/main/sd-vae-ft-ema-256x256"
files=(
